...
class _CupertinoContextMenuState extends State<CupertinoContextMenu>
  ...
  static double _computeScaleFactor(
      Rect childRect, EdgeInsets padding, Size size) {
    ...
    return clampDouble(
        math.min(minWidth, minHeight), _kMinScaleFactor, _kOpenScale);
  }
...
class _ContextMenuRoute<T> extends PopupRoute<T> {
  ...
  final Animatable<Rect?> _sheetRectAnimatableReverse =
...
class _ContextMenuRouteStaticState extends State<_ContextMenuRouteStatic>
  ...
  static double _getScale(
    ...
    return math.max(
        _kMinScale, (maxDragDistance + dyDirectional) / maxDragDistance);
  }
  ...
  Widget _buildChildAnimation(BuildContext context, Widget? child) {
    ...
    return Transform.scale(
        key: widget.childGlobalKey, scale: _lastScale, child: child);
  }
  ...
  void initState() {
    ...
    _sheetScaleAnimation =
        Tween<double>(begin: 1.0, end: 0.0).animate(_sheetCurvedAnimation);
    _sheetOpacityAnimation =
        Tween<double>(begin: 1.0, end: 0.0).animate(_sheetController);
    _setDragOffset(Offset.zero);
  }
  ...
  Widget build(BuildContext context) {
    final List<Widget> children =
        _getChildren(widget.orientation, widget.contextMenuLocation);
        ...
        child: ClipRRect(
          ...
          child: ColoredBox(
            color: CupertinoDynamicColor.resolve(
                CupertinoContextMenu.kBackgroundColor, context),
